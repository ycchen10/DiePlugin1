...
namespace Basic
{
    public class DrawingUtils : ClassItem
    {
        ...
        public static NXObject SetNote(Point3d point, double size, params string[] text)
        {
            ...
            int fontIndex1;
            fontIndex1 = workPart.Fonts.AddFont("微软雅黑", NXOpen.FontCollection.Type.Standard);
            ...
            draftingNoteBuilder1.Style.LetteringStyle.GeneralTextColor = workPart.Colors.Find("Deep Midnight");
        ...
        public static void SetWireframeColorSource(NXOpen.Preferences.GeneralWireframeColorSourceOption option, params View[] views)
        {
            ...
            editViewSettingsBuilder1.ViewStyle.ViewStyleGeneral.Scale.Numerator = 1.0;
            editViewSettingsBuilder1.ViewStyle.ViewStyleHiddenLines.Font = NXOpen.Preferences.Font.Invisible;
            editViewSettingsBuilder1.ViewStyle.ViewStyleSmoothEdges.SmoothEdge = false;
            try
            {
                NXOpen.NXObject nXObject1;
